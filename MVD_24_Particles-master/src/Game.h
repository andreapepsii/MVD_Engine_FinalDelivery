...
private:
	...
	void createSkybox(Shader* shader);
	void createTerrain(Shader* shader);
	void createBlendShape(Shader* shader);
	void addSimpleAnimation(Shader* shader);
	void addSkinnedAnimation(Shader* shader, std::string filename);
	void createMaterialSetExample(Shader* shader);
	void createAIexample(Shader* shader);
